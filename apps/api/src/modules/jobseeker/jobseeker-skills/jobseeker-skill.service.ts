...
export const JobseekerSkillService = {
    upsertSkill: async (userId: string, skillData: IJobseekerSkill) => {
    ...
    bulkUpsertSkills: async (userId: string, skillsArray: IJobseekerSkill[]) => {
        const jobseeker = await findJobseeker(userId)
    ...
    removeSkill: async (userId: string, entryId: string) => {
        const jobseeker = await findJobseeker(userId)
    ...
    bulkRemoveSkills: async (userId: string, entryIds: string[]) => {
